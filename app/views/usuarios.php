...
<label class='col-md-6'>
    ...
    <input type="text" class="form-control <?=hasError("cpf","is-invalid")?>" 
           id="cpf"    name="cpf" value="<?=old("cpf", _v($data,"cpf"))?>" >
    <div class='invalid-feedback'><?=getValidationError("cpf") ?></div>
</label>
